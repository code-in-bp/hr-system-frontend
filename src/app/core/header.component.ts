      ...
      <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav">
          <li class="nav-item active">
            <a class="nav-link ds-header-tabs" style="color: black;" routerLink=""
              >{{options[0].option}} <span class="sr-only">(current)</span></a
            >
          </li>

          <li class="nav-item active">
            <a class="nav-link ds-header-tabs" style="color: black;" routerLink="users-api"
          ...
          <li class="nav-item active">
            <a class="nav-link ds-header-tabs" style="color: black;" routerLink="users-api"
              >{{options[2].option}} <span class="sr-only"></span></a
            >
          </li>

          <li class="nav-item active">
            <a class="nav-link ds-header-tabs" style="color: black;" routerLink="users-api"
              >{{options[3].option}} <span class="sr-only"></span></a
            >
          </li>
        </ul>
      </div>
